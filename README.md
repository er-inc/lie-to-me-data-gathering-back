Lie To Me Data Gathering
===============

[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Wolox/lie-to-me-data-gathering-back?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Error Tracking](https://d26gfdfi90p7cf.cloudfront.net/rollbar-badge.144534.o.png)](https://rollbar.com)

`[![Codestats](http://codestats-url/organizations/your-organization/projects/lie-to-me-data-gathering-back/badge)](http://codestats-url/organizations/your-organization/projects/lie-to-me-data-gathering-back/badge)`
...
- Clone the repository by running `git clone git@github.com:Wolox/lie-to-me-data-gathering-back.git`
- Go to the project root by running `cd lie-to-me-data-gathering-back`
...
```bash
  ...
  CREATE ROLE "lie-to-me-data-gathering-back" LOGIN CREATEDB PASSWORD 'lie-to-me-data-gathering-back';
```
